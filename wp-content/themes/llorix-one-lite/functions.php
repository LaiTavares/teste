...
function llorix_one_lite_php_style() {
	...
	$llorix_one_lite_enable_move       = get_theme_mod( 'llorix_one_lite_enable_move' );
	$llorix_one_lite_frontpage_opacity = get_theme_mod( 'llorix_one_lite_frontpage_opacity', apply_filters( 'llorix_one_lite_frontpage_opacity_filter', 'rgba(0, 0, 0, 0.5)' ) );
	$llorix_one_lite_blog_opacity      = get_theme_mod( 'llorix_one_lite_blog_opacity', apply_filters( 'llorix_one_lite_blog_opacity_filter', 'rgba(0, 0, 0, 0.6)' ) );
